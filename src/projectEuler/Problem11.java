...
public class Problem11 {
    ...
    public static void main(String[] args) {
        ...
        int[][] grid = { row1, row2, row3, row4, row5, row6, row7, row8, row9, row10, row11, row12, row13, row14, row15, row16, row17, row18, row19, row20 };
        int greatest = 0;
        ...
        for (int x = 0; x < 20; x++) {
            ...
            while (mark < 20) {
                ...
                int diagonalLeftMultiplication = 1;
                int diagonalRightMultiplication = 1;
                int rowElement, columnElement, diagonalLeftElement, diagonalRightElement;
                
                if (mark >= 3) {
                    for (int y = 0; y < 4; y++) {
                        
                        // the element we start from
                        int index = mark - y;
                        
                        // horizontal
                        rowElement = grid[x][index];
                        rowMultiplication = rowMultiplication * rowElement;
                        
                        // vertical
                        columnElement = grid[index][x];
                        columnMultiplication = columnMultiplication * columnElement;
                ...
                if (mark >= 3 && x <= 16) {
                    //System.out.println("\nnew diagonal ");
                    for (int j = 0; j < 4; j++) {
                        diagonalLeftElement = grid[x+j][mark-j];
                        diagonalLeftMultiplication = diagonalLeftMultiplication * diagonalLeftElement;
                        //System.out.print(grid[x+j][mark-j] + ", ");
                    }
                }
                ...
                if (mark <= 16 && x <= 16) {
                    //System.out.println("\nnueva diagonal ");
                    for (int j = 0; j < 4; j++) {
                        diagonalRightElement = grid[x+j][mark+j];
                        diagonalRightMultiplication = diagonalRightMultiplication * diagonalRightElement;
                        //System.out.print(grid[x+j][mark+j] + ", ");
                    }
                }
                
                if (rowMultiplication > greatest) {
                    greatest = rowMultiplication;
                }
                if (columnMultiplication > greatest) {
                    greatest = columnMultiplication;
                }
                if (diagonalLeftMultiplication > greatest) {
                    greatest = diagonalLeftMultiplication;
                }
                if (diagonalRightMultiplication > greatest) {
                    greatest = diagonalRightMultiplication;
                }
